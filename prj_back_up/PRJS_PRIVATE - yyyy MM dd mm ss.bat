...
echo "______________________________________________________________________________________________________________________________ "%yyyyMMddHHmmss% >> PRJS_PRIVATE.log
echo "______________________________________________________________________________________________________________________________ "%~n0%~x0 >> PRJS_PRIVATE.log
call copy "E:\PRJS_PRIVATE\.mislile_server\git_add_push_commit.bat" "%cd%"
cmd /c call git_add_push_commit.bat >> PRJS_PRIVATE.log
call timeout 1
del git_add_push_commit.bat


explorer %directory_or_file_nx%
