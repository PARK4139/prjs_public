...
echo "______________________________________________________________________________________________________________________________ copy target && run target_copied && del target_copied
call copy "C:\Users\JungHoonPark\Desktop\PRJS_PRIVATE\.mislile_server\git_add_push_commit.bat" "%cd%"
cmd /c call git_add_push_commit.bat
call timeout 1
del git_add_push_commit.bat 
echo "______________________________________________________________________________________________________________________________ timeout 600
timeout 600
